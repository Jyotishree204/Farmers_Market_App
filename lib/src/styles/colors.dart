...
abstract class AppColors {
  ...
  static Color get lightgray => const Color(0xFFc8d6e5);

  static Color get darkblue => const Color(0xFF4e5b60);
  ...
  static Color get facebook => Color(0xff3b5998);

  static Color get google => Color(0xffea4335);
}
